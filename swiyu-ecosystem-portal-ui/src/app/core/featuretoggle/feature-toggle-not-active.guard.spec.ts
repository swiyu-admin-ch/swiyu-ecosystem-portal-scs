...
import {featureToggleNotActiveGuard} from './feature-toggle-not-active.guard';

describe('featureToggleNotActiveGuard', () => {
  const executeGuard: CanMatchFn = (...guardParameters) =>
    TestBed.runInInjectionContext(() => featureToggleNotActiveGuard(...guardParameters));
  ...
  it('should return true if the feature toggle is not active', () => {
  ...
  it('should return false if the feature toggle is active', () => {
  ...
  it('should return true if the feature toggle is not defined', () => {
    const route: Route = {
      data: {
